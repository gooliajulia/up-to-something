...
export default function Projects() {
    return (
        <div className='projects'>
            ...
            <div className='project'>
                <div className='images'>
                    <img src='../DesignMyWeekHome.png' alt='Foodies App Screenshot' />
                ...
                <div className='project-details'>
                    ...
                    <h4><span className='bold'>Deployed site:</span> <a href='https://fervent-swartz-34d852.netlify.app/' target="_blank">Design My Week</a></h4>
                    <h5 className='description'>Design My Week is </h5>
                    <h5><span className='bold'>Time to Complete:</span> 6 days</h5>
                    <h5 className='mission'><span className='bold'>Mission: </span></h5>
                    <ul>
                        <li>Build a ...</li>
                        <li>...Full CRUD generic controller actions on Back End </li>
            ...
            <div className='project'>
                <div className='images'>
                    <img src='../SunshineHome.png' alt='Foodies App Screenshot' />
                ...
                <div className='project-details'>
                    ...
                    <h5 className='description'>Sunshine Smoothies is </h5>
                    <h5><span className='bold'>Time to Complete:</span> 7 days</h5>
                    <h5 className='mission'><span className='bold'>Mission: </span></h5>
                    <ul>
                        <li>Build a ...</li>
                        <li>...Full CRUD generic controller actions on Back End </li>
